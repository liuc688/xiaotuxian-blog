...
## 2. 问：在 uni-app 中，如何进行全局状态管理？请介绍一下你对 Vuex 和 Pinia 的了解。
...
## 3. 问：uni-app 中的组件和 Vue.js 中的组件有什么区别？
...
## 4. 问：请介绍一下 uni-app 的网络请求库 uni.request 与 axios 相比，它有哪些优缺点？
...
## 5. 问：为什么用 VSCode 开发 uni-app 项目而不使用 Hbuilder？
...
## 7. 问：如何在 uni-app 项目中进行代码优化或性能优化？
...
<template>
  ...
  <scroll-view scroll-y @scroll="onScroll">
    <!-- 打印坐标 -->
    <view
      style="position: fixed; top: 100rpx; left: 50rpx; background-color: pink"
    >
      scrollTop:{{ scrollTop }}
    </view>
...
## 8. 在 uni-app 中，如何实现下拉刷新和上拉加载更多功能？
...
## 10. 问：请谈谈你在使用 uni-app 过程中遇到的问题，以及如何解决它们。
...
## 12. 问：请介绍 uni-app 中的条件编译和平台差异化处理?
